...
;  let payoff score-new rankings
;  set score score + payoff
;  
;  ;LIKE/UNLIKE 
;  let liked like-tags-in-topk rankings
;  draw-connections liked ;Easier to do here, than inside every function
;  
;  ;FOLLOW/UNFOLLOW
...
;  
;  ;OTHER:
;  draw-memories (sentence rankings candidates) ;draws memory links (can divide this inside Rank and Follow, but easier to handle at once)
;end
