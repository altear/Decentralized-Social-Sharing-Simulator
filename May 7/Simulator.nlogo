...
"" ""
PENS
"Benevolents" 1.0 0 -2674135 true "" "if count turtles with [breed = benevolents] > 0 [\nplot mean [score] of turtles with [breed  = benevolents]\n]"
"frankensteins1" 1.0 0 -13345367 true "" "if count turtles with [breed = frankensteins1] > 0 [\nplot mean [score] of turtles with [breed = frankensteins1]\n]"
"pen-2" 1.0 0 -7500403 true "" "if (ticks > 0) [plot mean [score] of turtles with [not document?]]"
"pen-3" 1.0 0 -8990512 true "" "if count turtles with [breed = frankensteins2] > 0 [\nplot mean [score] of turtles with [breed = frankensteins2]\n]"
